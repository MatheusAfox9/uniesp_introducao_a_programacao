...
if resultado >=6:
    print(f"Parabéns, você foi aprovado! A sua média é: {resultado}")
else:
    print(f"Não fique triste, infelizmente você foi reprovado. Ano que vem nos vemos de novo! A sua média é: {resultado}")